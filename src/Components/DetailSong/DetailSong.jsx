...
const DetailSong = ({ detailSong }) => {
  ...
  return (
    <div className="col-span-1 items-center flex justify-between flex-col md:border-r md:border-white max-h-screen">
      ...
      <div
        className={`max-w-64 max-h-64 md:max-w-72 md:max-h-72 md:w-72 md:h-72  flex justify-center items-center relative before:content-[''] before:absolute before:w-12 before:h-12 before:bg-white before:rounded-full before:border-2 before:border-black rounded-full border-2 border-white overflow-hidden ${
